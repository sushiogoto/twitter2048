...
(function() {
  var boardIsFull, buildBoard, collapseCells, generateTile, generateTileValue, getCol, getRow, highScore, isGameOver, mergeCells, move, moveIsValid, newGame, noValidMoves, printArray, randomCellIndices, randomInt, setCol, setRow, showBoard,
  ...
  highScore = function(board, highscore) {
  ...
  $(function() {
    ...
    _ref1 = highScore(this.board, this.score, this.highscore), this.score = _ref1[0], this.highscore = _ref1[1];
    $(".score-container").text(this.score);
    $(".best-container").text(this.highscore);
    return $("#clickme").click((function(_this) {
      return function() {
        $(".board").show("fast");
        $(".board").animate({
          opacity: 0,
        ...
        return $('body').keydown(function(event) {
          var direction, key, keys, newBoard, _ref2;
          key = event.which;
          keys = [37, 38, 39, 40];
          if (__indexOf.call(keys, key) >= 0) {
            ...
            if (moveIsValid(_this.board, newBoard)) {
              ...
              generateTile(newBoard);
              _ref2 = highScore(_this.board, _this.score, _this.highscore), _this.score = _ref2[0], _this.highscore = _ref2[1];
