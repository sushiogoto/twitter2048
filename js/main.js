...
(function() {
  var boardIsFull, buildBoard, collapseCells, generateTile, generateTileValue, getCol, getRow, highScore, isGameOver, mergeCells, move, moveIsValid, noValidMoves, printArray, randomCellIndices, randomInt, setCol, setRow, showBoard,
  ...
  noValidMoves = function(board, direction) {
    var newBoard;
  ...
  $(function() {
    ...
    return $('body').keydown((function(_this) {
      return function(event) {
        var direction, key, keys, newBoard, score;
        key = event.which;
        keys = [37, 38, 39, 40];
