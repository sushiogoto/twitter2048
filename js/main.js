...
(function() {
  var boardIsFull, buildBoard, collapseCells, endGame, generateTile, generateTileValue, getCol, getRow, hideEverything, isGameOver, mergeCells, move, moveIsValid, newGame, noValidMoves, printArray, randomCellIndices, randomInt, setCol, setRow, showBoard, shrinkStopFinal, totalScores,
  ...
  shrinkStopFinal = function(growthMulti, totalTime) {
    ...
    if (growthMulti >= 8) {
      ...
      return $(".board").animate({
        ...
        return function() {
          var _ref;
          return _ref = newGame(), _this.board = _ref[0], _this.score = _ref[1], _ref;
        };
      })(this));
    }
  };
        ...
        if (__indexOf.call(keys, key) >= 0) {
          ...
          if (moveIsValid(_this.board, newBoard)) {
            ...
            if (isGameOver(_this.board, direction)) {
              ...
              return _ref4 = newGame(), _this.score = _ref4[0], _this.board = _ref4[1], _ref4;
            } else {
